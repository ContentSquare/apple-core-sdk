...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ContentsquareCore",
            url: "https://github.com/ContentSquare/apple-core-sdk/releases/download/0.1.0/package.zip",
            checksum: "3e5c94ba7dc3dc0fbcf3ba72fab28a1f3b003ae4867d70c00286cd6b7a23d86d"
    )
    ],
